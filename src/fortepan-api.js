...
export const getSearchUrl = ({limit=100, q, yearFrom=1900, yearTo=1990, offset=0}) =>
    `${CORS}http://fortepan.hu/m/m.php?action=search_view&limit=${limit}&q=${q}&year_from=${yearFrom}&year_to=${yearTo}&offset=${offset}&lang=hu`
